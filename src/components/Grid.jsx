...
export default function Grid() {
  ...
  return (
    <>
      <div className="grid h-[400px] w-full grid-cols-3 grid-rows-4 p-4 gap-4">
        <Poster h="full" img={getUrl[2]} name={getNames[2]}/>
        <Poster h="2" img={getUrl[3]} name={getNames[3]}/>
        <Poster img={getUrl[4]} name={getNames[4]}/>
        <Poster h="3" img={getUrl[5]} name={getNames[0]}/>
        <Poster h="2" img={getUrl[6]} name={getNames[6]}/>
      </div>
    </>
  );
}
